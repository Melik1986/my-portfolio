	...
	return (
		<>
			<div
				...
				data-delay="0.4"
			>
				<HeroImage id="melik" src="/images/melik.svg" alt="Melik Musinian first-name wordmark" />
				<HeroImage id="musinian" src="/images/musinian.svg" alt="Musinian surname wordmark" />
			</div>
		</>
	);
}
