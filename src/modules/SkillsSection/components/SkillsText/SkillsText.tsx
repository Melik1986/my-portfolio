...
function Paragraph({ children, delay }: { children: React.ReactNode; delay: string }) {
	return (
		<p className={styles['skills__text']} data-animation="text-reveal" data-duration="1.2" data-ease="power2.out" data-delay={delay}>
			{children}
		</p>
	);
}
